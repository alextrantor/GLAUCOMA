...
async def startup_event():
    ...
    try:
        ...
        traceback.print_exc()
        sys.exit(3)  # Detener la app para que Render detecte el fallo

@app.get("/")
def root():
    return {"message": "API de Glaucoma corriendo correctamente"}
...
async def analyze_image(file: UploadFile = File(...)):
    ...
    is_nerve = nerve_probability < 0.5
    ...
    if is_nerve:
        ...
        results["glaucoma_suspected"] = cdr_prediction > 0.5
